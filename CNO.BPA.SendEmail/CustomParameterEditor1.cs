...
namespace CNO.BPA.SendEmail
{
    public partial class CustomParameterEditor1 : Form
    {
        ...
        //(02/08/2022)public CustomParameterEditor1(ref CustomParameters ParmsCustom, string ProcessName)
        public CustomParameterEditor1(ref CustomParameters ParmsCustom)
        {
            InitializeComponent();
            _parmsCustom = ParmsCustom;
            //(02/08/2022)_processName = ProcessName;
